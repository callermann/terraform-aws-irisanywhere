...
variable "asg_spot_pools" {
  type        = string
  description = "The number of Spot pools to use to allocate your Spot capacity. The Spot pools are determined from the different instance types in the Overrides array of LaunchTemplate."
  default     = "2"
}

variable "bootstrap_labels" {
  type        = list
  description = "List of labels to add.  The string should be in the format 'label=value'"
  default     = []
}
